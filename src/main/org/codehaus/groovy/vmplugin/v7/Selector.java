    ...
    private static class MethodSelector extends Selector {
        ...
        public void correctCoerce() {
            ...
            for (int i=0; i<args.length; i++) {
                ...
                // For Array store operations the target type should be the Component
                // Type, forcing type coersion if necessary.
                if (i == 2 && selectionBase.isArray()) {
                    target = selectionBase.getComponentType();
                }
                ...
                Class wrappedPara = TypeHelper.getWrapperClass(target);
                ...
                if (target.isAssignableFrom(got)) continue;
