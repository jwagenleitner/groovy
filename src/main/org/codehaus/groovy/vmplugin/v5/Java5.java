...
public class Java5 implements VMPlugin {
     ...
     * parameter of an inner class constructor is annotated.  This method will normalize
     * the annotation array so that it contains the same number of elements as the array
     * returned from {@link Constructor#getParameterTypes()}.
     *
